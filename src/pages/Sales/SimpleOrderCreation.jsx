                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                {materials.map(m => (
                                    <button
                                        ...
                                        className={`p-4 rounded-xl border-2 text-base font-medium transition-all touch-manipulation ${String(formData.material_id) === String(m.material_id)
                                ...
                                <div className="flex gap-3">
                                    {TYPE_OPTIONS.map(t => (
                                        <button
                                            ...
                                            className={`flex-1 p-4 rounded-xl border-2 text-base font-medium transition-all touch-manipulation ${formData.type_item === t.value
                                    ...
                                    <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
                                        {widthValues.map(w => (
                                            <button
                                                ...
                                                className={`p-4 rounded-xl border-2 text-base font-medium transition-all touch-manipulation ${formData.width === w.value
                                ...
                                {availableRulers.length === 0 ? (
                                    ...
                                    availableRulers.map(r => (
                                        <button
                                            ...
                                            className={`p-4 rounded-xl border-2 text-base font-medium transition-all touch-manipulation ${String(formData.ruler_id) === String(r.ruler_id)
