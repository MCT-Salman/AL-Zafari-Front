...
const ResultsCounter = ({
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="px-4 py-1 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg text-sm font-semibold text-blue-900 border border-blue-200 shadow-sm transition-all duration-200">
